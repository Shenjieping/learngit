...
(function($) {
    $.flexbox = function(div, o) {
        ...
        var $ctr = $('<div></div>')
            ...
            .css('width', inputWidth + arrowWidth+o.contentPos.w)
            .css('top', top+o.contentPos.t)
            .css('left', 0+o.contentPos.l)
        ...
        function displayItems(d, q) {
            ...
            for (var i = 0; i < d[o.resultsProperty].length; i++) {
                ...
                if (exactMatch || (++itemCount == 1 && o.selectFirstMatch) || selectedMatch) {
                	//alert(exactMatch+"--"+itemCount+"--"+o.selectFirstMatch+"--"+selectedMatch);
